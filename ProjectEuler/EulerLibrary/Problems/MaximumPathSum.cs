...
{
    public class MaximumPathSum : IEulerSolution
    {
        /// <summary>
            ...
            for (int row = 1; row < size; row++)
                for (int column = 0; column < size - row; column++)
                {
                    ...
                    if (numbers[row - 1, column] > numbers[row - 1, column + 1])
                        higherNumber = numbers[row - 1, column];
                    else
                        higherNumber = numbers[row - 1, column + 1];
                    numbers[row, column] = numbers[row, column] + higherNumber;
                }

            return numbers[size - 1, 0].ToString();
        }
    }
}
